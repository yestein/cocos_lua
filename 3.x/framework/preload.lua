...
AddPreloadFile("framework/game_mgr")
AddPreloadFile("framework/real_timer")
AddPreloadFile("framework/logic_timer")

AddPreloadFile("framework/cocos2d/display_random")
...
AddPreloadFile("framework/cocos2d/puppet_pool")
